...
/** Four categorical hues, area, diverging magnitude, and shape, ported from Overwatch. */
...
/** Fixed identities: four categorical slots, then null. Never cycle a palette. */
 ...
 *  black and white or read by somebody with a colour vision deficiency. Shape
 *  and hue are separate choices, so their vocabularies need not be equal. */
...
/** An SVG path for a shape, centred on the origin. */
